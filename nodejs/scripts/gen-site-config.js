...
const contractsDir = path.join(nodeRoot, "smart-contract", "contracts-deployed");

dotenv.config({ path: path.join(nodeRoot, ".env.site") });
...
function main() {
  ...
  const banner = "// Auto-generated by nodejs/scripts/gen-site-config.js. Do not edit by hand.\n";
