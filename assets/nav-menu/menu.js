(function () {
  ...
  function markActiveLinks() {
    ...
    if (articlesTrigger && articleLinks.some((link) => link.classList.contains("is-active"))) {
      articlesTrigger.classList.add("is-active");
      articlesTrigger.setAttribute("aria-current", "page");
    }
  }
